...
window.onload = function init() {
    ...
    gl.uniform1i( gl.getUniformLocation(program, "tala"), tala);
    ...
    document.getElementById("btnPhong").onclick = function(){
        tala = 1;
        gl.uniform1i( gl.getUniformLocation(program, "tala"), tala);
        init();
    };
    document.getElementById("btnBlinnPhong").onclick = function(){
      tala = 2;
      gl.uniform1i( gl.getUniformLocation(program, "tala"), tala);
        init();
    };
