...
window.onload = function init() {
    ...
    var proj = perspective( 20.0, 1.0, 0.2, 100.0 );
...
var render = function(){
    ...
    gl.uniform4fv( gl.getUniformLocation( program1, "Color" ), vec4(0.0, 0.5, 1.0, 1.0) );
    ...
    gl.uniformMatrix4fv(locModelView1, false, flatten(mv1));
    gl.uniform4fv( gl.getUniformLocation( program1, "Color" ), vec4(1.0, 1.0, 0.0, 1.0) );
    ...
    gl.uniformMatrix4fv(locModelView1, false, flatten(mv1));
    gl.uniform4fv( gl.getUniformLocation( program1, "Color" ), vec4(0.0, 1.0, 0.5, 1.0) );
    ...
    mv2 = mult( mv2, translate( 0.0, 0.3, -0.0301 ) );
    mv2 = mult( mv2, rotateX( 5 ));
    mv2 = mult( mv2, rotateY( 180 ));
    mv2 = mult( mv2, scalem( 0.27, 0.27, 0.01 ) );
