...
var lightvar = vec4( 1.0, 1.0, 1.0, 1.0 );
...
window.onload = function init() {
    ...
    gl.uniform1f( gl.getUniformLocation(program, "birta"), birta);
...
// function litur(){
//   var talastrengur = tala.toString();
//   for(var i = 0; i <= tala.length;i++){
//     var j = talastrengur.charAt(i);
//     fylki[i]= (j + 1)/10;
//   }
// }
function skipta(tala){
  var talastrengur = tala.toString();
  if(talastrengur.length == 3){
    var r = ((parseFloat(talastrengur.charAt(0)))+1)/10;
    var g = ((parseFloat(talastrengur.charAt(1)))+1)/10;
    var b = ((parseFloat(talastrengur.charAt(2)))+1)/10;
  }else if (talastrengur.length == 2) {
    var r = 0.0;
    var g = ((parseFloat(talastrengur.charAt(0)))+1)/10;
    var b = ((parseFloat(talastrengur.charAt(1)))+1)/10;
  }else if (talastrengur.length == 1) {
    var r = 0.0;
    var g = 0.0;
    var b = ((parseFloat(talastrengur.charAt(0)))+1)/10;
